...
import movies.util.QueryCreate;
import movies.util.SQLExec;
import movies.util.SQLMapper;
...
public class ShowDao {
    ...
    public static  List<Show> getShows(String field,String value){
        ...
        try{
            ...
            }else if (field.equals("id")|| field.equals("mid")||field.equals("hall")){//多个整型查询
                query=QueryCreate.queryForResults("shows",field,Integer.parseInt(value));
            }else if(field.equals("price")){//小数查询
